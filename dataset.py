...
def get_training_set(opt, spatial_transform, temporal_transform,
                     target_transform, keyframe_tansfrom):
    ...
    if opt.dataset == 'kinetics':
        ...
        training_data = UCF101(
            ...
            opt.annotation_path,
            'training',
            keyframe_tansfrom=keyframe_tansfrom,
            spatial_transform=spatial_transform,
            temporal_transform=temporal_transform,
            target_transform=target_transform)
...
def get_test_set(opt, spatial_transform, temporal_transform, target_transform, keyframe_tansfrom):
    assert opt.dataset in ['kinetics', 'activitynet', 'ucf101', 'hmdb51']

...
def parse_opts():
    ...
    parser.add_argument (
        '--Feature_Extraction' ,
        action='store_true',
        help='If True, the model will used as feature extraction ')
    parser.add_argument(
        '--root_path',
        default='/home/data/',
        type=str,
    ...
    parser.add_argument(
        '--annotation_path',
        default='annotation_dir/hmdb51_1.json',
        type=str,
    ...
    parser.add_argument(
        '--pretrain_path', default='/home/data/resnet-101-kinetics.pth', type=str, help='Pretrained model (.pth)')
    parser.add_argument(
        '--ft_begin_index',
        default=5,
        type=int,

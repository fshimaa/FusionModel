...
def train_epoch(epoch, data_loader, lstm_model,spatail_model,temporal_model,classifer, criterion, optimizer, opt,
    ...
    for i, (clips,key_frame, targets) in enumerate(data_loader):
        ...
        # spatail_feature = spatail_feature.view (spatail_feature.size (0) , -1 , spatail_feature.size (-1))  # (batch_size,64,2048)
